...
describe('ReaderView', () => {
  it('renders the article title', () => {
    render(<ReaderView article={mockArticle} isRead={false} onClose={() => {}} onToggleRead={() => {}} onArchive={() => {}} />)
  ...
  it('has a back button that calls onClose', async () => {
    const onClose = vi.fn()
    render(<ReaderView article={mockArticle} isRead={false} onClose={onClose} onToggleRead={() => {}} onArchive={() => {}} />)
